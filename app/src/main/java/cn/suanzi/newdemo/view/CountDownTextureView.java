...
public class CountDownTextureView extends TextureView
    ...
    private static final String TAG = CountDownTextureView.class.getSimpleName();
    ...
    private static final float DEFAULT_TIME_PAINT_STROKE = 0.20f;
    ...
    public CountDownTextureView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.init(context, attrs);
    }


    public CountDownTextureView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public CountDownTextureView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        TypedArray typedArray = context.obtainStyledAttributes(attrs,
                R.styleable.CountDownTextureView);
        this.timeHour = typedArray.getInteger(R.styleable.CountDownTextureView_easyCountHour,
                0);
        this.timeMinute = typedArray.getInteger(
                R.styleable.CountDownTextureView_easyCountMinute, 0);
        this.timeSecond = typedArray.getInteger(
                R.styleable.CountDownTextureView_easyCountSecond, 0);
        ...
        this.rectWidth = typedArray.getDimension(
                R.styleable.CountDownTextureView_easyCountRectWidth,
                this.dp2px(DEFAULT_RECT_WIDTH));
        this.rectHeight = typedArray.getDimension(
                R.styleable.CountDownTextureView_easyCountRectHeight,
                this.dp2px(DEFAULT_RECT_HEIGHT));
        this.rectSpacing = typedArray.getDimension(
                R.styleable.CountDownTextureView_easyCountRectSpacing,
        ...
        this.rectRadius = typedArray.getDimension(
                R.styleable.CountDownTextureView_easyCountRectRadius,
    ...
    private void initColonPaint(@NonNull final TypedArray typedArray) {
        ...
        this.colonPaint.setColor(
                typedArray.getColor(R.styleable.CountDownTextureView_easyCountColonColor,
                        DEFAULT_COLOR_COLON));
        this.colonPaint.setTextSize(
                typedArray.getDimension(R.styleable.CountDownTextureView_easyCountColonSize,
                        this.dp2px(DEFAULT_TIME_TEXT_SIZE)));
        this.colonPaint.setStrokeWidth(
                typedArray.getDimension(R.styleable.CountDownTextureView_easyCountColonStroke,
    ...
    private void initTimePaint(@NonNull final TypedArray typedArray) {
        ...
        this.timePaint.setColor(
                typedArray.getColor(R.styleable.CountDownTextureView_easyCountTimeColor,
                        DEFAULT_COLOR_TIME));
        this.timePaint.setTextSize(
                typedArray.getDimension(R.styleable.CountDownTextureView_easyCountTimeSize,
                        this.dp2px(DEFAULT_COLON_TEXT_SIZE)));
        this.timePaint.setStrokeWidth(
                typedArray.getDimension(R.styleable.CountDownTextureView_easyCountTimeStroke,
    ...
    private void initRectBorderPaint(@NonNull final TypedArray typedArray) {
        final float rectBorderStroke = typedArray.getDimension(
                R.styleable.CountDownTextureView_easyCountRectBorderStroke, Float.MIN_VALUE);
        ...
        this.rectBorderPaint.setColor(
                typedArray.getColor(R.styleable.CountDownTextureView_easyCountRectBorderColor,
    ...
    private void initBackgroundPaint(@NonNull final TypedArray typedArray) {
        ...
        this.backgroundPaint.setColor(
                typedArray.getColor(R.styleable.CountDownTextureView_easyCountBackgroundColor,
    ...
    private void drawZeroZeroZero() {
        Canvas canvas = null;
        try {
            canvas = CountDownTextureView.this.lockCanvas();
            if (canvas == null) {
                return;
            }
