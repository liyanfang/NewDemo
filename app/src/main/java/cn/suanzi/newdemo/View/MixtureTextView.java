...
public class MixtureTextView extends RelativeLayout
{
    ...
    private int INDEX_ATTR_TEXT_SIZE = 0;
    private int INDEX_ATTR_TEXT_COLOR = 0;
    private int INDEX_ATTR_TEXT = 0;
    ...
    private void readAttrs(Context context, AttributeSet attrs)
    {
        ...
        mTextSize = ta.getDimensionPixelSize(0, mTextSize);
        mTextColor = ta.getColor(1, mTextColor);
        mText = ta.getString(2);
        ta.recycle();
