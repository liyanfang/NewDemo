...
//        right_edge = getResources().getDrawable(R.drawable.ic_category_right_edge);
	...
	private void addTab(final int position, String title) {
		...
		TextView categoryText = (TextView) tab.findViewById(R.id.category_text);
        ...
        while (i < tabsContainer.getChildCount()) {
            if (i < currentPosition - 1 || i > currentPosition + 1) {
                ...
                if (category_text != null) {
                    ...
                    textDrawable.setTextColor(getResources().getColor(R.color.colorPrimary));
...
//        right_edge.draw(canvas);
	...
	private class PageListener implements OnPageChangeListener {
		...
		public void onPageScrollStateChanged(int state) {
			Log.d("LYF", "onPageScrollStateChanged  state: " +  state);
		...
		public void onPageSelected(int position) {
			Log.d("LYF", "onPageSelected position : " +  position);
